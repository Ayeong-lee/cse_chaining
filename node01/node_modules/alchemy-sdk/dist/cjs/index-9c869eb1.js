    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-37ca9896.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-d7d9a709.js'); });
...
function getOwnersForContract(config, contractAddress, options, srcMethod = 'getOwnersForContract') {
    return __awaiter$1(this, void 0, void 0, function* () {
        ...
        return Object.assign({ owners: response.ownerAddresses, totalCount: response.totalCount }, (response.pageKey !== undefined && { pageKey: response.pageKey }));
    });
}
...
function computeRarity(config, contractAddress, tokenId, refreshCache, srcMethod = 'computeRarity') {
    return __awaiter$1(this, void 0, void 0, function* () {
...
function summarizeNftAttributes(config, contractAddress, refreshCache, srcMethod = 'summarizeNftAttributes') {
    return __awaiter$1(this, void 0, void 0, function* () {
...
//# sourceMappingURL=index-9c869eb1.js.map
