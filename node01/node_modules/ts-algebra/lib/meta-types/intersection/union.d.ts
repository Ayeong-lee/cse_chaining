...
export declare type DistributeIntersection<META_UNION extends UnionType, META_TYPE> = $Union<RecurseOnUnionValues<UnionValues<META_UNION>, META_TYPE>>;
declare type RecurseOnUnionValues<VALUES extends Type, META_TYPE> = VALUES extends infer VALUE ? $Intersect<VALUE, META_TYPE> : never;
export {};
