...
export declare type DistributeUnion<META_UNION extends UnionType, META_TYPE> = $Union<RecurseOnUnionValues<UnionValues<META_UNION>, META_TYPE>>;
...
export declare type ExcludeUnion<META_TYPE, META_UNION extends UnionType> = If<IsNever<UnionValues<META_UNION>>, META_TYPE, ExcludeUnionValue<META_TYPE, UnionLast<UnionValues<META_UNION>>, META_UNION>>;
